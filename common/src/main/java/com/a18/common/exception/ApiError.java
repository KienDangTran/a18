...
public class ApiError {
   ...
   * Validation error.
   *
   * To understand how to use and build messages which this class. Take the following json serialized example:
   *
   * <pre>
   * {
   *   "field": "loginName",
  ...
  public static class ApiSubError {
    ...
    /**
     * The message to be shown on the frontend, which actually message key only. Frontend will use this key so search
