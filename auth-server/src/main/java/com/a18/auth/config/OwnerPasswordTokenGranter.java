...
public class OwnerPasswordTokenGranter extends AbstractTokenGranter {
  ...
  public OAuth2AccessToken grant(@NotNull Authentication authentication) {
    ...
    TokenRequest tokenRequest = this.getRequestFactory().createTokenRequest(parameters, authenticatedClient);
